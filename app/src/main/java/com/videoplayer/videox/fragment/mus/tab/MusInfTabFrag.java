...
public class MusInfTabFrag extends BasFrag<MusInfPre> implements MusInfVie, MusInfAdapter.Callback {
    ...
    public MusInfTabFrag() {
        this.contentObserver = new ContentObserver(new Handler()) { // from class: com.videoplayer.videox.fragment.mus.tab.MusInfTabFrag.1
            @Override // android.database.ContentObserver
            public void onChange(boolean z, Uri uri) {
                if (MusInfTabFrag.this.mPresenter != null) {
                    ((MusInfPre) MusInfTabFrag.this.mPresenter).openMusicsTab();
                }
            }
        };
    ...
    public MusInfTabFrag(List<MusicInfo> list) {
        this.contentObserver = new ContentObserver(new Handler()) { // from class: com.videoplayer.videox.fragment.mus.tab.MusInfTabFrag.2
            @Override // android.database.ContentObserver
            public void onChange(boolean z, Uri uri) {
                if (MusInfTabFrag.this.mPresenter != null) {
                    ((MusInfPre) MusInfTabFrag.this.mPresenter).openMusicsTab();
    ...
    public static MusInfTabFrag newInstance() {
        return new MusInfTabFrag();
    }

    public static MusInfTabFrag newInstance(List<MusicInfo> list) {
        return new MusInfTabFrag(list);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(R.layout.fragment_music_info_tab, viewGroup, false);
    }
    ...
    public void onViewCreated(View inflate, Bundle savedInstanceState) {
        ...
        this.refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.videoplayer.videox.fragment.mus.tab.MusInfTabFrag$$ExternalSyntheticLambda0
            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public final void onRefresh() {
                MusInfTabFrag.this.m644xf3e201bc();
            }
        });
    }

    /* renamed from: lambda$onCreateView$0$MusicInfoTabFragment, reason: merged with bridge method [inline-methods] */
    public void m644xf3e201bc() {
